...
import (
	...
	"github.com/borderlesshq/graphrpc/libs/99designs/gqlgen/internal/imports"
)
...
func Render(cfg Options) error {
	...
	if cfg.GeneratedHeader {
		result.WriteString("// Code generated by github.com/borderlesshq/graphrpc/libs/99designs/gqlgen, DO NOT EDIT.\n\n")
	}
	if cfg.PackageDoc != "" {
