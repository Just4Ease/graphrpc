...
import (
	...
	"github.com/borderlesshq/graphrpc/libs/99designs/gqlgen/plugin/federation/fieldset"
)
	...
	builtins := config.TypeMap{
		"_Service": {
			Model: config.StringList{
				"github.com/borderlesshq/graphrpc/libs/99designs/gqlgen/plugin/federation/fedruntime.Service",
			},
		},
		"_Entity": {
			Model: config.StringList{
				"github.com/borderlesshq/graphrpc/libs/99designs/gqlgen/plugin/federation/fedruntime.Entity",
			},
		},
		"Entity": {
			Model: config.StringList{
		...
		"_Any": {
			Model: config.StringList{"github.com/borderlesshq/graphrpc/libs/99designs/gqlgen/graphql.Map"},
		},
	}
