...
// otherwise, the name of the executable is used.  "graphrpc" is the default
// for the NATS server.
...
func intercept(format string, v ...interface{}) string {
	format = strings.ReplaceAll(format, "nats-server", "GraphRPC Server")
