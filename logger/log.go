...
func (l *Logger) Noticef(format string, v ...interface{}) {
	l.logger.Printf(intercept(l.infoLabel+format, v...))
}

// Warnf logs a notice statement
func (l *Logger) Warnf(format string, v ...interface{}) {
	l.logger.Printf(intercept(l.warnLabel+format, v...))
}

// Errorf logs an error statement
func (l *Logger) Errorf(format string, v ...interface{}) {
	l.logger.Printf(intercept(l.errorLabel+format, v...))
}

// Fatalf logs a fatal error
func (l *Logger) Fatalf(format string, v ...interface{}) {
	l.logger.Fatalf(intercept(l.fatalLabel+format, v...))
}

// Debugf logs a debug statement
func (l *Logger) Debugf(format string, v ...interface{}) {
	if l.debug {
		l.logger.Printf(intercept(l.debugLabel+format, v...))
	}
}
...
func (l *Logger) Tracef(format string, v ...interface{}) {
	if l.trace {
		l.logger.Printf(intercept(l.traceLabel+format, v...))
	}
}
