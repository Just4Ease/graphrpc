...
import (
	...
	htransport "github.com/borderlesshq/graphrpc/libs/99designs/gqlgen/graphql/handler/transport"
	...
	"github.com/borderlesshq/graphrpc/libs/infiotinc/gqlgenc/client/extensions"
...
func round(cli *client.Client) {
	var v interface{}
	_, err := cli.Query(context.Background(), "", _example.RoomQuery, map[string]interface{}{"name": "test"}, &v)
	if err != nil {
		fmt.Println("ERROR QUERY: ", err)
	}

	res := cli.Subscription(context.Background(), "", _example.MessagesSub, nil)
	if err != nil {
